...
//WRBOGY
////TLFRReBo
    int i00, i01, i02, i03, i10, i11, i12, i13, i20, i21, i22, i23, i30, i31, i32, i33, i40, i41, i42, i43, i50, i51, i52, i53;
    printf("Enter the element 0 of Top Face:");
    scanf("%d", &i00);
    printf("Enter the element 1 of Top Face:");
    scanf("%d", &i01);
    printf("Enter the element 2 of Top Face:");
    scanf("%d", &i02);
    printf("Enter the element 3 of Top Face:");
    scanf("%d", &i03);
    printf("Enter the element 0 of Left Face:");
    scanf("%d", &i10);
    printf("Enter the element 1 of Left Face:");
    scanf("%d", &i11);
    printf("Enter the element 2 of Left Face:");
    scanf("%d", &i12);
    printf("Enter the element 3 of Left Face:");
    scanf("%d", &i13);
    printf("Enter the element 0 of Front Face:");
    scanf("%d", &i20);
    printf("Enter the element 1 of Front Face:");
    scanf("%d", &i21);
    printf("Enter the element 2 of Front Face:");
    scanf("%d", &i22);
    printf("Enter the element 3 of Front Face:");
    scanf("%d", &i23);
    printf("Enter the element 0 of Right Face:");
    scanf("%d", &i30);
    printf("Enter the element 1 of Right Face:");
    scanf("%d", &i31);
    printf("Enter the element 2 of Right Face:");
    scanf("%d", &i32);
    printf("Enter the element 3 of Right Face:");
    scanf("%d", &i33);
    printf("Enter the element 0 of Rear Face:");
    scanf("%d", &i40);
    printf("Enter the element 1 of Rear Face:");
    scanf("%d", &i41);
    printf("Enter the element 2 of Rear Face:");
    scanf("%d", &i42);
    printf("Enter the element 3 of Rear Face:");
    scanf("%d", &i43);
    printf("Enter the element 0 of Bottom Face:");
    scanf("%d", &i50);
    printf("Enter the element 1 of Bottom Face:");
    scanf("%d", &i51);
    printf("Enter the element 2 of Bottom Face:");
    scanf("%d", &i52);
    printf("Enter the element 3 of Bottom Face:");
    scanf("%d", &i53);
    vector<vector<int>> initialBoard = {{i00, i01, i02, i03}, {i10, i11, i12, i13}, {i20, i21, i22, i23}, {i30, i31, i32, i33}, {i40, i41, i42, i43}, {i50, i51, i52, i53}};
